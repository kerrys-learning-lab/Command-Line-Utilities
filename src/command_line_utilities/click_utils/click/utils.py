...
def enforce_mutually_exclusive(mutex_list: list[str],
                               ctx: click.Context,
                               current: click.Parameter,
                               value):
...
def read_stdin(value: str, prompt: str|None|bool = None) -> str:
    ...
    if prompt or prompt is None:
        ...
        print(f"{prompt}.  New-line/LF is allowed.  Use CTRL-D on a blank line to end",
            file=sys.stderr)
